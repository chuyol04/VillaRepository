...
namespace MagicVilla_API.Controllers.v1
{
    ...
    public class VillaController : ControllerBase
    {
        ...
        [HttpGet]
        [ResponseCache(CacheProfileName = "Default30")]//durante 30 segundos si ya existe esta consulta la tendre en memoria, evitara hacer la llamada al endpoint 
        [Authorize(Roles ="admin", AuthenticationSchemes = "Bearer")] //indica que si quiero acceder tengo que estar autorizado
